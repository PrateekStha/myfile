     ...
     @if(session()->has('delete'))
      ...
      <div class="col-3">
          <div class="ratio-16-9">
            <a href="#">
              <div class="ratio-image"  data-toggle="modal" data-target="#modal-center{{$slider->id}}" style="background-image: url('/storage/image/slider/{{$slider->image}}');">
              </div>
            </a>
            <!-- Modal -->
              <div class="modal center-modal fade" id="modal-center{{$slider->id}}" tabindex="-1">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                  	<h1>{{$slider->title}}</h1>
                  <img src="/storage/image/slider/{{$slider->image}}" alt="" srcset=""><br>
  ...
  <div class="modal modal-right fade" data-backdrop="false" id="modal-upload" tabindex="-1">
            ...
            <div class="modal-content">
              ...
              <button type="button" class="close" data-dismiss="modal">
                ...
                <form class="form-horizontal form-element" method="post" enctype="multipart/form-data" action="slider">       
              {{csrf_field()}}
                  <div class="modal-body">
